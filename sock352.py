...
import struct, sys, time, binascii, threading
...
# the encryption flag 
# When the socket is created and a connection is wanting to be established
# we check whether this is passed as an argument.
global ENCRYPT
...
class socket:
    ...
    def __init__(self):
        ...
        # Sets boolean for whether the message is encrypted or not
    ...
    def connect(self,*args):
        ...
        # Set the OPT_PTR to 0x1 if encrypted. It should be 0x0 by default.
        ...
        ack_packet = self.createPacket(flags=SOCK352_ACK, opt_ptr=self.encrypted_flag,
    ...
    def create_data_packets(self, buffer):
        ...
        for i in range(0, total_packets):
            ...
            if self.is_encrypted:
                ...
                sending_data = self.box.encrypt(sending_data, nonce)
